...
//        }
        ...
        String values = jedis.get("user1");
        User user2 = JSON.parseObject(values,User.class);
        print(47,user2.toString());
